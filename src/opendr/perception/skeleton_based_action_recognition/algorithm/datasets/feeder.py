...
class Feeder(Dataset):
    ...
    def load_data(self):
        ...
        if self.data_name == 'nturgbd':
            ...
            # joint_pairs = (#shoulders to elbows and left elbow to left wrist 
            # 	      	    (0, 2), (1, 3), (2, 4),
		    #   	    # Left hand
		    #         (4, 5), (5, 6), (6, 7), (7, 8),
		    ...
		    #         (25, 30), (30, 31), (31, 32), (32, 33), (30, 34), (34, 35),
		    #         (35, 36), (36, 37), (34, 38), (38, 39), (39, 40), (40, 41),
		    #         (38, 42), (42, 43), (43, 44), (44, 45), (25, 42))
            
            joint_pairs =  ((0, 2), (1, 3), (2, 4), (0,1),
                    # Left hand
                    (4, 5), (5, 6), (6, 7), (7, 8),
                    (4, 9), (9, 10), (10, 11), (11, 12), (4,13), (13, 14),
                    (14, 15), (15, 16), (4, 17), (17, 18), (18, 19), (19, 20),
                    (21, 22), (22,23), (23,24), (4, 21),
                    # Right elbow to right wrist
                    (3,25),
                    # Right hand
                    (25, 26), (26, 27), (27, 28), (28, 29), 
                    (25, 30), (30, 31), (31, 32), (32, 33), (25, 34), (34, 35),
                    (35, 36), (36, 37), (25, 38), (38, 39), (39, 40), (40, 41),
                    (42, 43), (43, 44), (44, 45), (25, 42))
