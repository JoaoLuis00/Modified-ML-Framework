...
class ProgressiveSpatioTemporalGCNLearner(Learner):
    ...
    def __load_from_pt(self, path, verbose=True):
        ...
        if path is not None:
            ...
            for current_key in self.model.state_dict():
                ...
                if ('g_conv' or 'gcn_residual' or 'tcn.t_conv.bias' or 'residual' or 'bn.weight' or 'bn.bias' or
    ...
    def download(self, path=None, method_name="pstgcn", mode="pretrained", verbose=True,
